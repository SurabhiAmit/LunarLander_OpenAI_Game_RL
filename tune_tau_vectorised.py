...
DqnAgent = Dqn(state_dim, num_actions, alpha=0.0005, epsilon_decay=0.995, gamma=0.99,tau=0.0001)
done = False
j, k = 0, 0
...
DqnAgent2 = Dqn(state_dim, num_actions, alpha=0.0005, epsilon_decay=0.995, gamma=0.99,tau=0.005)
done = False
j, k = 0, 0
train1, train2, train3, train4, train5, train6, train7, train8, train9, train10 = {}, {}, {}, {}, {}, {}, {}, {}, {}, {}
print("VECTORISED TAU TUNING")
...
plot_sma_s(DqnAgent.train_mode_rewards, DqnAgent1.train_mode_rewards, DqnAgent2.train_mode_rewards, title="Moving average of Rewards (window=100) in training period",
           label1='Moving average for tau = 0.0001', label2="Moving average for tau = 0.001",
           label3='Moving average for tau = 0.005', window=100)
plot_sma_s(DqnAgent.test_mode_rewards, DqnAgent1.test_mode_rewards, DqnAgent2.test_mode_rewards,
           ...
           label1='Moving average for tau = 0.0001', label2="Moving average for tau = 0.001",
           label3='Moving average for tau = 0.005', window=25)
